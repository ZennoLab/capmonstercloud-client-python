...
class RecognitionCITImageRequestTest(unittest.TestCase):
    ...
    imageUrlsExamples = [
        "https://i.postimg.cc/H8yBD5FJ/0-2.png",
        "https://i.postimg.cc/rz0hrXz8/0-0.png",
    ...
    def testImagesFilling(self):
        with self.assertRaises(
            ...
            request = RecognitionComplexImageTaskRequest(
                metadata=RecognitionCITImageRequestTest.metadataExample, imagesBase64=[]
            )
    ...
    def testExtraMetadata(self):
        with self.assertRaises(
            TypeError, msg="Expect that extra metadata fields will be cause TypeError"
        ):
            request = RecognitionComplexImageTaskRequest(
                metadata={"Task": "oocl_rotate_new", "asd": "asd"},
                imagesBase64=RecognitionCITImageRequestTest.imageBase64Examples,
            )
